...
// over 339 entries.
// Nested {shape, func} aggregate matches the `{ {M, N, K, CU}, &kernel }`
// initializer the codegen emits. The key type and the search over it are
// shared with the other arches in opus_gemm_lookup_entry.cuh.
using OpusA16W16Shape = OpusLookupKey;
